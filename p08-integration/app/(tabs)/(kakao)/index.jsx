...
export default function KakaoBusScreen() {
  ...
  const ListHeaderComponent = () => (
    <View style={{ backgroundColor: NEW_COLOR.GRAY_3_GRAY_2 }}>
      ...
      <Margin height={16} />
      <View style={{ flexDirection: 'row', width: '80%', justifyContent: 'space-between', alignSelf: 'center', alignItems: 'center' }}>
        <BookmarkButton 
          isBookmarked={true}
        ...
        <Link href="/friends">
          <Ionicons name="people" size={20} color={NEW_COLOR.WHITE_BLACK} />
        </Link>
      </View>
      <Margin height={24} />
    </View>
